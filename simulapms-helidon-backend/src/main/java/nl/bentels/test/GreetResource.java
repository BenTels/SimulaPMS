...
public class GreetResource {
	...
	private static final Logger LOGGER = java.util.logging.Logger.getLogger(GreetResource.class.getCanonicalName());
     ...
     *
     * @param greeting JSON containing the new greeting
